...
export class MIDIDeviceHandler {
  ...
  connectMIDIOutputToSeq(output, seq) {
    ...
    console.log(`%cPlaying MIDI to %c${output.name}`, consoleColors.info, consoleColors.recognized)
  }
  ...
  disconnectSeqFromMIDI(seq) {
    ...
    console.log('%cDisconnected from MIDI out.', consoleColors.info)
  }
  ...
  disconnectDeviceFromSynth(input) {
    ...
    console.log(`%cDisconnected from %c${input.name}`, consoleColors.info, consoleColors.recognized)
  }
